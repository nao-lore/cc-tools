...
export const metadata: Metadata = {
  ...
  description: "Free online time zone converter. Convert time across worldwide time zones. Compare multiple zones, check DST status, and find current local times.",
