  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 py-8 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">CSS Text Shadow</h1>
          <p className="text-gray-400 mb-8">Create CSS text-shadow effects with a visual editor</p>
          <TextShadowGenerator />
        </div>
