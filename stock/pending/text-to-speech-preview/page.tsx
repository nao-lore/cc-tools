        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <a href="/" className="text-xs text-blue-600 hover:text-blue-800 px-2 py-1 bg-blue-50 rounded">Readability Score</a>
              <a href="/" className="text-xs text-blue-600 hover:text-blue-800 px-2 py-1 bg-blue-50 rounded">Text Case Converter</a>
              <a href="/" className="text-xs text-blue-600 hover:text-blue-800 px-2 py-1 bg-blue-50 rounded">Keyword Density</a>
            </div>
          </div>
