...
export default function ChangelogFormatter() {
  ...
  return (
    ...
    <details className="bg-gray-50 rounded-lg p-4 open:bg-gray-100">
      <summary className="font-medium text-gray-700 cursor-pointer select-none">What does this Changelog Formatter tool do?</summary>
      <p className="mt-2 text-sm text-gray-600">Format git commit messages into a structured changelog. Just enter your values and get instant results.</p>
    </details>
    <details className="bg-gray-50 rounded-lg p-4 open:bg-gray-100">
    ...
    <details className="bg-gray-50 rounded-lg p-4 open:bg-gray-100">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What does this Changelog Formatter tool do?", "acceptedAnswer": {"@type": "Answer", "text": "Format git commit messages into a structured changelog. Just enter your values and get instant results."}}, {"@type": "Question", "name": "Is this tool free to use?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, completely free. No sign-up or account required."}}, {"@type": "Question", "name": "How accurate are the results?", "acceptedAnswer": {"@type": "Answer", "text": "Results are estimates based on standard formulas. For critical decisions, please consult a qualified professional."}}]})}} />
  ...
  "description": "Format git commit messages into a structured changelog",
  "url": "https://tools.loresync.dev/changelog-formatter",
