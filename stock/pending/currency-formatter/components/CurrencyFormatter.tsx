...
export default function CurrencyFormatter() {
  ...
  "@type": "WebApplication",
  "name": "Currency Format Previewer",
  "description": "Preview how a number formats as currency in different locales",
  "url": "https://tools.loresync.dev/currency-formatter",
