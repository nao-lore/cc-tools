...
export default function Home() {
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              ...
              <Link href="/nenrei-keisan" className="text-xs text-blue-600 hover:text-blue-800 px-2 py-1 bg-blue-50 rounded">年齢計算</Link>
  ...
  "@type": "WebApplication",
  "name": "電気代計算ツール",
  "description": "電気代計算ツール — Free online tool. No signup required.",
  "url": "https://tools.loresync.dev/denki-keisan",
