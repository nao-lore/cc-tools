        ...
        <div className="max-w-3xl mx-auto px-4 py-6">
          ...
          <section className="mt-10 space-y-6 text-sm leading-relaxed text-muted">
            ...
            <div className="flex flex-wrap gap-2">
              <Link href="/oven-temp-converter" className="text-xs text-blue-600 hover:text-blue-800 px-3 py-1.5 bg-blue-50 rounded-lg border border-blue-200">オーブン温度換算</Link>
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <Link href="/oven-temp-converter" className="text-xs text-blue-600 hover:text-blue-800 px-2 py-1 bg-blue-50 rounded">オーブン温度換算</Link>
